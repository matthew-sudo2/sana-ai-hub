import { BadgeCheck, Copy, Download, Loader, AlertCircle } from "lucide-react";
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          ...
          {isLoading || !reportContent ? (
            ...
            <>
              ...
              {/* ML Model Disclaimer */}
              <div className="mb-6 flex items-start gap-3 rounded-lg border border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/30 p-4">
                <AlertCircle className="h-5 w-5 text-amber-600 dark:text-amber-500 mt-0.5 flex-shrink-0" />
                <div className="flex-1">
                  <p className="font-display text-sm font-semibold text-amber-900 dark:text-amber-100">Machine Learning Model Notice</p>
                  <p className="font-body text-xs text-amber-800 dark:text-amber-200 mt-1">
                    The ML quality scores and analysis results are generated by machine learning models, which can sometimes be inaccurate or make errors. 
                    <strong> Please verify critical insights and results independently before making important decisions.</strong>
                  </p>
                </div>
              </div>
